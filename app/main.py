                    ...
                    ui.select(
                        {
                            item.id:
                                (
                                    f"{item.interview_type.value.title()} "
                                    f"#{item.id}"
                                )
                            for item
                            in mocks
    ...
    try:
        ...
        with ui.column().classes(
            ...
            heading(
                "Faculty dashboard",
                (
                    "Cohort-level readiness "
                    "and mentor allocation."
                ),
            )
            ...
            if (
                ...
                def assign_mentor():
                    if (
                        not student_select.value
                        or not mentor_select.value
                    ):
                        ui.notify(
                            (
                                "Select student "
